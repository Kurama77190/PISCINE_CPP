...
/*   Updated: 2025/02/25 19:01:19 by sben-tay         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ClapTrap::takeDamage(unsigned int amount)
{
	if (this->_energyPoints == 0 || this->_hitPoints == 0)
	{
		if (_hitPoints == 0)
			...
			std::cout << "ClapTrap " << this->_name << " doesn't have hits pointss" << std::endl;
		return ;
	}
	std::cout << "ClapTrap " << this->_name << " lost : " << amount << " hits points."  << std::endl;
