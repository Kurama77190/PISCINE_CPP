...
/*   Updated: 2025/04/15 19:13:49 by sben-tay         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	o << "ShrubberyCreationForm: " << i.getName() << ", isSigned: " << i.getIsSigned() << ", requiredGradeToSign: " << i.getRequiredGradeToSign() << ", requiredGradeToExecute: " << i.getRequiredGradeToExecute();
	return (o);
}
